...
CREATE TABLE `servicios` (
    ...
    INDEX `servicios_ibfk_1`(`id_vehiculo`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `servicios` ADD CONSTRAINT `servicios_ibfk_1` FOREIGN KEY (`id_vehiculo`) REFERENCES `vehiculos`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE `servicios_tipos_servicios_tipos_vehiculos` ADD CONSTRAINT `servicios_tipos_servicios_tipos_vehiculos_ibfk_1` FOREIGN KEY (`id_servicio`) REFERENCES `servicios`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE `tipos_servicios_tipos_vehiculos` ADD CONSTRAINT `tipos_servicios_tipos_vehiculos_ibfk_1` FOREIGN KEY (`id_tipo_servicio`) REFERENCES `tipos_servicios`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
